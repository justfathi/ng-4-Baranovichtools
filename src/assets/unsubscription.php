...
if(empty($errors))
{
	...
	$href = 'http://baranovichytools.ru/getSubscr/email?del=';
	
	$email_subject = "Отписаться от новостей Библиотеки инструментов";
	...
	$message .= "Eсли Вы хотите отписаться от Библиотеки инструментов, то <br />";
