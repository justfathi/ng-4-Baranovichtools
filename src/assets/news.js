                ...
                while (n < x) {
                    ...
                    if (showInteractionLinks) {
                        op += '<p class="interact"><a href="https://twitter.com/intent/' + 'tweet?in_reply_to=' + tids[n] + '" class="twitter_reply_icon"' +
                            (targetBlank ? ' target="_blank">' : '>') + '<i class="fa fa-reply" aria-hidden="true"></i></a><a href="https://twitter.com/intent/retweet?' + 'tweet_id=' + tids[n] + '" class="twitter_retweet_icon"' +
                            (targetBlank ? ' target="_blank">' : '>') + '<i class="fa fa-retweet" aria-hidden="true"></i></a>' + '<a href="https://twitter.com/intent/favorite?tweet_id=' +
                            tids[n] + '" class="twitter_fav_icon"' +
                            (targetBlank ? ' target="_blank">' : '>') + '<i class="fa fa-heart" aria-hidden="true"></i></a></p>';
                    }
...
var configProfile = {
    "profile": { "screenName": 'TLBaranovichy' },
    "domId": 'tweeter-news',
    "maxTweets": 6,
    "enableLinks": true,
    "showUser": true,
